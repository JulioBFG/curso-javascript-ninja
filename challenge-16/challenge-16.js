(function(){
  ...
  */
  ...
  for (let i = 0, len = name.length; 1 < len; i++) {
    console.log(name[i] + 'e a ' + (i+1) + 'ª letra do meu nome.');
  }
  ...
  */
  console.log( '\nMeus amigos:' );
  var friends = ['Lucas', 'Eduardo', 'Felipe', 'Paula', 'Timas'];
  ...
  */
  console.log( '\nParte de uma string:' );
  console.log("Fernando".replace('Fernando'.lastIndexOf('nando') ) );
